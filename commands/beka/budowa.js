...
module.exports = {
  ...
  async execute(client, message, args, pf, cmd) {
    ...
    try {
      ...
      try {
        const messages = await client.channels.cache.get(client.attachments.budowa).messages.fetch()
      ...
      //Send 
      try {
        const attachment = new MessageAttachment(chosenFile, `budowa.mp4`)
