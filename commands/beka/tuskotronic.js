...
module.exports = {
  ...
  async execute(client, message, args, pf, cmd) {
    ...
    try {
      ...
      try {
        const messages = await client.channels.cache.get(client.attachments.tuskotronic).messages.fetch()
      ...
      //Send 
      try {
        const attachment = new MessageAttachment(chosenFile, `tuskotronic.mp4`)
