...
module.exports = {
  ...
  async execute(client, interaction) {
    try {
      ...
      let files = []
      await client.channels.cache.get(client.cmds.attachments.tuskotronic).messages.fetch().then(async msgs => msgs.forEach(msg => files.push(msg.attachments.array()[0].url)))
